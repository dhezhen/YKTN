  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo site_url('ppdb/pengumuman');?>"> <span class="glyphicon glyphicon-bullhorn" aria-hidden="true"></span>Peserta</a> </li>

			<li><a href="<?php echo site_url('ppdb/jadwal');?>"><span class="glyphicon glyphicon-calendar" aria-hidden="true"></span> Arahan Kedatangan </a></li>
