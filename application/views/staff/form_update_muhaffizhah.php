...
<html>
<head>
	<title> Update Muhaffizhah</title>
</head>
...
<div class="panel-heading">
  ...
  <h2>Muhaffizhah  - <?php echo $peserta->nama_lengkap;?></h2>
<div class="progress" data-percent="">
		<div class="bar" style="width:100%;"></div>
					</div>

    
		 <?= form_open_multipart('staff/proses_update_muhaffizhah', ['class'=>'form-horizontal']) ?>
