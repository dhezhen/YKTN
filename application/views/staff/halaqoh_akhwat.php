...
<?php $info=$this->session->flashdata('error');
 ...
 <a href="<?php echo base_url() ?>excel/export"> <i class='fas fa-file-excel ' style='font-size:36px;color:green'></i></a>
        ...
        <?php if (is_array($peserta_akhwat)||is_object($peserta_akhwat))
        {
          foreach ($peserta_akhwat as $peserta)
				{
				?>
				<tr>
					...
					<td><a href="<?php echo site_url('staff/update_muhaffizhah/'.$peserta->id_peserta);?>" >Update Muhaffizhah</a></td>
